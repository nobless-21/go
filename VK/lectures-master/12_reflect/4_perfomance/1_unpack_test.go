...
go tool pprof -http :9090  main.test cpu.out
go tool pprof -svg -inuse_objects main.test mem.out > mem_oo.svg
go tool pprof -svg -inuse_space main.test mem.out > mem_os.svg
go tool pprof -svg -alloc_space main.test mem.out > mem_as.svg
go tool pprof -svg -alloc_objects main.test mem.out > mem_ao.svg
go tool pprof -svg main.test cpu_out.txt > cpu.svg
